...
% Add vertical space before and after section headers
\usepackage{titlesec}
\titlespacing*{\section}{0pt}{1.5em}{1em}
\titlespacing*{\subsection}{0pt}{1.2em}{0.8em}
\titlespacing*{\subsubsection}{0pt}{1em}{0.6em}

% Improve itemize indentation and spacing
\usepackage{enumitem}
\setlist[itemize]{left=1.5em, itemsep=0.5em, topsep=0.5em}

% Add a bit more space before/after tables and verbatim blocks
\setlength{\intextsep}{1.2em}
\setlength{\textfloatsep}{1.2em}
\setlength{\abovecaptionskip}{0.8em}
...
0, 'too\_small': 0, 'no\_spy': 0\}\}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{../results/figures/buy_and_hold_pnl.png}
    \end{center}
    { \hspace*{\fill} \\}
